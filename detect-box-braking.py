...
def main():
    ...
    # move_task = asyncio.create_task(control.moveAtVelocity(0, 20, 0, 0, 0, 0))
    # detect_task = asyncio.create_task(control.detectBox())

    # rospy.Subscriber('/webcam2/image_raw2', Image, callback=control.camCallback)
    ...
    # varIsBoxDetected = True
    # while True:
    #     await asyncio.gather(move_task, detect_task)
    #     if control.isBoxDetected == True:
    #         break
    ...
    #         control.moveAtVelocity(0, 10, 0, 0, 0, 0)
    #         last_move_time = current_time

    # while True:
    #     move_thread.join(1)
    #     detect_thread.join(0.1)
    #     if control.isBoxDetected:
    #         break
    ...
    #     control.moveAtVelocity(0, 20, 0, 0 ,0 ,0)
    #     end_time = time.time()
